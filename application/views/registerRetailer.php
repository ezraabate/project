...
<body>
   <form role="form" action="<?php echo base_url('register/registerRetailer') ?>" method="post" id="retailcreateform" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group" >
                  ...
                  <input type="text" class="form-control" id="sname" name="sname" placeholder="second name" autocomplete="off" value="<?php echo set_value('sname');?>">
                </div>
                <div class="form-group required" >
                ...
                <div class="form-group required" >
                  ...
                  <input type="text" class="form-control" id="retname" name="retname" placeholder="Retail name" autocomplete="off" value="<?php echo set_value('retname');?>">
                </div>


                <div class="form-group required" >
                  <label for="phone" class="control-label">Phone No</label>
                  <input type="text" class="form-control" id="phone" name="phone" placeholder="phone no" autocomplete="off" value="<?php echo set_value('phone');?>">
                </div>
                ...
                <div class="form-group" >
                  ...
                  <input type="text" class="form-control" id="city" name="city" placeholder="city" autocomplete="off" value="<?php echo set_value('city');?>">
                </div>

                <div class="form-group" >
                  <label for="scity" class="control-label">Subcity</label>
                  <input type="text" class="form-control" id="scity" name="scity" placeholder="sub city" autocomplete="off" value="<?php echo set_value('scity');?>">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="password" class="form-control" id="password" name="password" placeholder="Password" autocomplete="off" value="<?php echo set_value('password');?>">
                </div>

                <div class="form-group required" >
                  <label for="cpassword " class="control-label">Confirm password</label>
                  <input type="password" class="form-control" id="cpassword" name="cpassword" placeholder="Confirm Password" autocomplete="off" value="<?php echo set_value('cpassword');?>">
                </div>
...
<script type="text/javascript">
  $(document).ready(function() {
       $('#subs').multiselect({
  nonSelectedText :'Select Category(ies) that you want to subscribe',
