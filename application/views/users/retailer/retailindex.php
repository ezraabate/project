    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div id="messages"></div>
          ...
          <a href="<?php echo base_url('users/createretail') ?>" class="btn btn-primary">Add New Retailers</a>
            <br /> <br />

          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Manage Retailers</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="retailTable" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th>Owner Name</th>
                  <th>Retail name</th>
...
$(document).ready(function() {
  ...
  manageTable = $('#retailTable').DataTable({
    'ajax': 'fetchRetailData',
    'order': []
  });
});
