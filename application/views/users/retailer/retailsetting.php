...
.form-group.required .control-label:after{
      ...
      <div class="row">
        <div class="col-md-6 col-xs-12 col-md-offset-2">
          ...
          <div class="box" >
            ...
            <!-- /.box-header -->
            <form role="form" action="<?php base_url('users/retailsetting') ?>" method="post" id="retailupdateform">
              <div class="box-body">
                ...
                <div class="form-group required" >
                  ...
                  <input type="text" class="form-control" id="retname" name="retname" placeholder="Retail name" autocomplete="off" required value="<?php echo $user_data['Retail_name']?>">
                </div>
 ...
 <script type="text/javascript">
  $(document).ready(function() {
         ...
         $('#retailupdateform').bootstrapValidator({
