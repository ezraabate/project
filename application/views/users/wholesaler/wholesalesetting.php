...
.form-group.required .control-label:after{
      ...
      <div class="row">
        <div class="col-md-6 col-xs-12 col-md-offset-2">
          ...
          <div class="box" >
            ...
            <!-- /.box-header -->
            <form role="form" action="<?php base_url('users/wholesalesetting') ?>" method="post" id= 
              "updatewholesaleform">
              <div class="box-body">
                ...
                <div class="form-group required" >
                  ...
                  <input type="text" class="form-control" id="wname" name="wname" placeholder="Wholesale name" autocomplete="off" required value="<?php echo $user_data['wholesale_name']?>">
                </div>

                
                <div class="form-group required" >
                  <label for="tno" class="control-label">Tin No</label>
                  <input type="text" class="form-control" id="tno" name="tno" placeholder="Tin No" autocomplete="off" required value="<?php echo $user_tin['TIN_number']?>">
                </div>
                <div class="form-group required" >
                  <label for="baccno" class="control-label">License No</label>
                  <input type="text" class="form-control" id="lno" name="lno" placeholder="License No" autocomplete="off" required value="<?php echo $user_tin['License_number']?>">
                </div>
                ...
                <div class="form-group required" >
                  ...
                  <input type="text" class="form-control" id="mplace" name="mplace" placeholder="Market Place" autocomplete="off" required value="<?php echo $user_add['MarketPlace']?>">
                </div>
                <div class="form-group">
                  <div class="alert alert-error alert-dismissible" role="alert">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                ...
                <div class="form-group required" >
                  ...
                  <input type="password" class="form-control" id="cpassword" name="cpassword" placeholder="Confirm Password" autocomplete="off"  value="">
                </div>
 ...
 <script type="text/javascript">
  $(document).ready(function() {
     ...
     $('#updatewholesaleform').bootstrapValidator({
