    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <a href="<?php echo base_url('users/createwholesale') ?>" class="btn btn-primary">Add New Wholesaler</a>
            <br /> <br />
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <table id="wholeTable" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th>Owner Name</th>
...
$(document).ready(function() {
  ...
  manageTable = $('#wholeTable').DataTable({
    'ajax': 'fetchWholeData',
    'order': []
  });
});
