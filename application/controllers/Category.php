	...
	public function fetchCategoryData()
	{
		...
		foreach ($data as $key => $value) {
			...
			$buttons = '';
				...
				$buttons .= '<button type="button" class="btn btn-success" onclick="editFunc('.$value['categ_id'].')" data-toggle="modal" data-target="#editModal"><i class="fa fa-edit"></i></button>';
			

			
				// $buttons .= ' <button type="button" class="btn btn-danger" onclick="removeFunc('.$value['categ_id'].')" data-toggle="modal" data-target="#removeModal"><i class="fa fa-trash"></i></button>';
	...
	*/
	public function update($id)
	{
		...
		if($id) {
	        ...
	        if ($this->form_validation->run() == TRUE) {
	        	$data = array(
	        		'categ_name' => $this->input->post('edit_category_name'),
